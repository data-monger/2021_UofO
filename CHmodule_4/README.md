...
Though the impact was marginal- it should be noted the freshman class of THS successfully impacted all levels of analysis; Math Scores by grade, Reading Scores by grade, Scores by School Spending, Scores by School Size, Scores by School Type, School Summary; In fact- we could say they've impacted the entire School District Analysis- which is precisely why we were tasked with rerunning this process to begin with.

The side by side comparisons provide us the opportunity to quickly guage the impact, identify to what extent and address the malfeasance occordingly.
